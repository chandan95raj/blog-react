  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuClose}>
        <Link to="/dashboard"><Button variant="outlined" color="success"
      ...
      {isAuthOrNot ?
        <>
          <MenuItem>
            ...
            <Link to="/"><Typography variant="body1">Write</Typography></Link>
          </MenuItem>
          <MenuItem>
            <IconButton
              size="large"
            ...
            <Link to="/"><Typography variant="body1">Notifications</Typography></Link>
          </MenuItem>
          <MenuItem onClick={handleProfileMenuOpen}>
            ...
            <Link><Typography variant="body1">Profile</Typography></Link>
          </MenuItem>
        </> :
        <>
          <MenuItem>
          ...
          <MenuItem>
            <Link to="/login"><Button variant="contained" color="success"
              startIcon={<LogIn />}>
              Login
            </Button>
            </Link>
          ...
          <Box sx={{ display: 'flex' }} alignItems={'center'}>
            {
              isAuthOrNot ?
                ...
                <Box gap={2} sx={{ display: { xs: 'none', md: 'flex' } }}>
                  ...
                  <Link to="/join"><Button variant="contained"
                    endIcon={<LogIn />}>
                    Join
                  </Button>
                  </Link>
